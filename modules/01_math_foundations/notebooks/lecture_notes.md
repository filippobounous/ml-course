...
Work the problem set in `../problems/README.md`. In particular: derive every inequality you use, implement the pseudoinverse and Gaussian MLE in NumPy (write them in `../problems/starter.py`; reference in `../problems/_reference/solutions.py`), and simulate the double-well Langevin SDE.
